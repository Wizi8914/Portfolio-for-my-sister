...
slideCarousel = (carousel, index) => {
    ...
    carouselButtons[carousel].children[0].href = `${crlSlide[index].src.split('/').slice(0, -1).join("/")}${crlSlide[index].src.split('/')[crlSlide[index].src.split('/').length - 2] == "video" ? "/" : "/full-size/"}${crlSlide[index].src.split('/').pop().replace(".jpg", ".png")}`;
    carouselButtons[carousel].children[1].href = `${crlSlide[index].src.split('/').slice(0, -1).join("/")}${crlSlide[index].src.split('/')[crlSlide[index].src.split('/').length - 2] == "video" ? "/" : "/full-size/"}${crlSlide[index].src.split('/').pop().replace(".jpg", ".png")}`;    
